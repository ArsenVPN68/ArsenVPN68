...
function get\u0076\u006c\u0065\u0073\u0073Config(userID, hostName) {
  ...
  // تغییرات برای "Panel 68"
  const note = `
    <div class="panel-68-container">
        <span class="panel-68-text">Panel 68</span>
    </div>
  `;
...
.panel-68-container {
    ...
    border-radius: 12px;
    display: inline-block; /* To make container fit content */
...
.panel-68-text {
    ...
    font-size: 3.5em; /* Very large font size */
    font-weight: bold;
...
@media (max-width: 576px) {
    ...
    .panel-68-text {
        font-size: 2em; /* Even smaller on very small screens */
    }
    .panel-68-container {
        margin: 20px auto;
        padding: 8px 10px;
