...
function get\u0076\u006c\u0065\u0073\u0073Config(userID, hostName) {
  ...
  // این خط، لینک‌های کانال و یوتیوب را حذف کرده و به جای آن "68" را با استایل مورد نظر نمایش می‌دهد.
  const note = `<span style="font-family: 'Arial Black', sans-serif; color: #FF0000; font-size: 2em; font-weight: bold;">68</span>`;
  ...
  const wk\u0076\u006c\u0065\u0073\u0073share = btoa(`\u0076\u006c\u0065\u0073\u0073\u003A//${userID}\u0040${IP1}:${PT1}?encryption=none&security=none&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D68#CF_V1_${IP1}_${PT1}\n\u0076\u006c\u0065\u0073\u0073\u003A//${userID}\u0040${IP2}:${PT2}?encryption=none&security=none&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D68#CF_V2_${IP2}_${PT2}\n\u0076\u006c\u0065\u0073\u0073\u003A//${userID}\u0040${IP3}:${PT3}?encryption=none&security=none&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D68#CF_V3_${IP3}_${PT3}\n\u0076\u006c\u0065\u0073\u0073\u003A//${userID}\u0040${IP4}:${PT4}?encryption=none&security=none&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D68#CF_V4_${IP4}_${PT4}\n\u0076\u006c\u0065\u0073\u0073\u003A//${userID}\u0040${IP5}:${PT5}?encryption=none&security=none&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D68#CF_V5_${IP5}_${PT5}\n\u0076\u006c\u0065\u0073\u0073\u003A//${userID}\u0040${IP6}:${PT6}?encryption=none&security=none&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D68#CF_V6_${IP6}_${PT6}\n\u0076\u006c\u0065\u0073\u0073\u003A//${userID}\u0040${IP7}:${PT7}?encryption=none&security=none&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D68#CF_V7_${IP7}_${PT7}\n\u0076\u006c\u0065\u0073\u0073\u003A//${userID}\u0040${IP8}:${PT8}?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D68#CF_V8_${IP8}_${PT8}\n\u0076\u006c\u0065\u0073\u0073\u003A//${userID}\u0040${IP9}:${PT9}?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D68#CF_V9_${IP9}_${PT9}\n\u0076\u006c\u0065\u0073\u0073\u003A//${userID}\u0040${IP10}:${PT10}?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D68#CF_V10_${IP10}_${PT10}\n\u0076\u006c\u0065\u0073\u0073\u003A//${userID}\u0040${IP11}:${PT11}?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D68#CF_V11_${IP11}_${PT11}\n\u0076\u006c\u0065\u0073\u0073\u003A//${userID}\u0040${IP12}:${PT12}?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Ded%3D68#CF_V12_${IP12}_${PT12}\n\u0076\u006c\u0065\u0073\u0073\u003A//${userID}\u0040${IP13}:${PT13}?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Ded%3D68#CF_V13_${IP13}_${PT13}`);
...
function copyToClipboard(text) {
  ...
  alert('Copied to clipboard!'); // Translated
}
</script>
`;
    ...
    <div class="row">
	    ...
	    <hr>
			...
			<table class="table">
				...
				<tbody>
					<tr>
						<td class="limited-width">TLS encryption disabled, ignores domain blocking</td>
            ...
            <ul>
                <li>Client Address (address): Custom domain OR optimal domain OR optimal IP OR reverse proxy IP</li>
                <li>Port (port): 7 HTTP ports can be chosen (80, 8080, 8880, 2052, 2082, 2086, 2095), or reverse proxy IP corresponding port</li>
                <li>User ID (uuid): ${userID}</li>
                <li>Transfer Protocol (network): ws OR websocket</li>
                <li>Spoof Domain (host): ${hostName}</li>
                <li>Path (path): /?ed=68</li>
                <li>Transport Security (TLS): Disabled</li>
            </ul>
            <hr>
            <hr>
            <hr>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <td class="limited-width">TLS encryption enabled,<br>If the client supports fragmentation, it is recommended to enable it to prevent domain blocking</td>
            ...
            <ul>
                <li>Client Address (address): Custom domain OR optimal domain OR optimal IP OR reverse proxy IP</li>
                <li>Port (port): 6 HTTPS ports can be chosen (443, 8443, 2053, 2083, 2087, 2096), or reverse proxy IP corresponding port</li>
                <li>User ID (uuid): ${userID}</li>
                <li>Transfer Protocol (network): ws OR websocket</li>
                <li>Spoof Domain (host): ${hostName}</li>
                <li>Path (path): /?ed=68</li>
            ...
            <br>
            <br>
            <h3>3: Aggregate General, Clash-meta, Sing-box Subscription Links:</h3>
            <hr>
            <p>Note:<br>1. Each subscription link includes 13 port nodes (TLS + non-TLS) by default.<br>2. The current workers domain as a subscription link needs to be updated via a proxy.<br>3. If the client used does not support fragmentation, TLS nodes may not be available.</p>
            <hr>
            <table class="table">
                <thead>
                    <tr>
                        <th>Aggregate General Share Link (can be directly imported into client):</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th>Aggregate General Subscription Link:</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th>HTTP Ports Subscription Share Link (can be directly imported into client):</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th>HTTPS Ports Subscription Share Link (can be directly imported into client):</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <br>
            <br>
            <h3>4: Aggregate General, Clash-meta, Sing-box Subscription Proxy Links:</h3>
            <hr>
            <p>Note:<br>1. Each subscription link includes 13 port nodes (TLS + non-TLS) by default.<br>2. The current workers domain as a subscription link needs to be updated via a proxy.<br>3. If the client used does not support fragmentation, TLS nodes may not be available.</p>
            <hr>
            <table class="table">
                <thead>
                    <tr>
                        <th>Aggregate General Subscription Proxy Link:</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th>Clash-meta Subscription Proxy Link:</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th>Sing-box Subscription Proxy Link:</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
