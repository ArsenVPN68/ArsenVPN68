...
if command -v figlet &>/dev/null; then
    figlet -f slant "ArsenVPN68"
fi
echo -e "${cyan}*****************************************${reset}"
echo -e "${cyan}*${reset} ${red}T${green}E${yellow}L${purple}E${cyan}G${green}R${white}A${red}M${reset} : ${purple}ArsenVPN68${reset}         ${cyan}"
echo -e "${cyan}*****************************************${reset}"
...
if [ "$user_input" -eq 1 ]; then
    ...
    echo -e "${green}After this, you can run the Selector with ${cyan}68 ${green}command${reset}"
else 
