...
.container {
    background-color: #2e2e4a; /* Slightly lighter purple for container */
    border-radius: 15px;
    padding: 30px;
...
hr {
    border-top: 2px solid #5a5a80; /* Thicker, slightly lighter separator */
    margin-top: 20px;
    margin-bottom: 20px;
}
.table {
...
.table th, .table td {
    border-color: #5a5a80; /* Matching border color */
    color: #e0e0e0;
    padding: 12px 15px;
...
.table tbody tr:nth-child(even) {
    background-color: #444466; /* Alternate row color */
}
.limited-width {
    max-width: 250px; /* Increased width for better readability */
    overflow: auto;
